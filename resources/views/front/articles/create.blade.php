        ...
        <div class="mt-5 mb-3 col-md-4 px-2">
            <div class="container">
                <div class="card mx-auto border-0 shadow mb-3">
                    <div class="card-body">
                        <input class="form-control" name="title" type="text" placeholder="@lang('front.news-title')">
                    </div>
                </div>
                <div class="card mx-auto border-0 shadow mb-3">
                    <div class="card-body">
                        <textarea class="form-control" name="short" placeholder="@lang('front.news-summary')" rows="3" style="resize: none;"></textarea>
                    </div>
                </div>
                <div class="card mx-auto border-0 shadow mb-3">
                ...
                <div class="card mx-auto border-0 shadow mb-3">
                    <div class="card-body">
                        <input class="form-control" name="keywords" type="text" placeholder="@lang('front.keywords')">
                    </div>
                </div>
                ...
                <div class="card mx-auto border-0 shadow mb-3">
                    <div class="card-body">
                        <input class="form-control" name="source" type="text" placeholder="@lang('front.source') (@lang('front.optional'))">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-5 mb-3 col-md-8 px-2">
            <div class="container">
                <div class="card mx-auto border-0 shadow">
                    ...
                    <div class="card-body">
                        <textarea id="content" name="content" class="form-control" placeholder="@lang('news.content')" height="500"></textarea>
                    </div>
                </div>
            </div>
        </div>
