...
<form id="create-tv-article-form">
    @csrf
    <div class="row">
        <div class="col-lg-9">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="source" name="source" placeholder="@lang('dashboard.enter') @lang('dashboard.source')">
                    </div>
                </div>
            </div>
            <!-- end card -->
                ...
                <div class="card-body">
                    <div class="col-lg-12">
                        <div class="mb-3">
                            ...
                            <input class="form-control" placeholder="@lang('dashboard.enter') @lang('dashboard.keywords')" id="keywords" name="keywords" data-choices data-choices-text-unique-true data-choices-removeItem type="text" />
                        </div>
                    </div>
                </div>
            </div>
